...
## 목차
- [kubernetes mysql 구축 (pv,pvc 연결) 및 백업 파일 생성 가이드](#kubernetes-mysql-구축-pvpvc-연결-및-백업-파일-생성-가이드)
  - [목차](#목차)
- [ 1. 문서 개요](#-1-문서-개요)
  - [ 1.1. 목적](#-11-목적)
- [ 2. pv, pvc 생성](#-2-pv-pvc-생성)
  - [2.1. pv 생성 파일 작성](#21-pv-생성-파일-작성)
  - [2.2. pv 생성 결과 확인](#22-pv-생성-결과-확인)
  - [2.3. pvc 생성 파일 작성](#23-pvc-생성-파일-작성)
  - [2.4. pvc 생성 결과 확인](#24-pvc-생성-결과-확인)
  - [2.5. pv, pvc 연결 확인](#25-pv-pvc-연결-확인)
- [ 3. configmap 생성](#-3-configmap-생성)
  - [3.1. configmap 생성 파일 작성](#31-configmap-생성-파일-작성)
  - [3.2. configmap 생성 결과 확인](#32-configmap-생성-결과-확인)
- [ 4. secret 생성](#-4-secret-생성)
  - [4.1. secret 생성 파일 작성](#41-secret-생성-파일-작성)
  - [4.2. secret 생성 결과 확인](#42-secret-생성-결과-확인)
- [ 5. statefulSet 생성](#-5-statefulset-생성)
  - [5.1. statefulSet 생성 파일 작성](#51-statefulset-생성-파일-작성)
  - [5.2. statefulSet 생성 결과 확인](#52-statefulset-생성-결과-확인)
- [ 6. service 생성](#-6-service-생성)
  - [6.1. service 생성 파일 작성](#61-service-생성-파일-작성)
  - [6.2. service 생성 결과 확인](#62-service-생성-결과-확인)
- [ 7. mysql 접속 확인](#-7-mysql-접속-확인)
  - [7.1. 접속 방법](#71-접속-방법)
    - [7.1.1 외부에서 접속 방법](#711-외부에서-접속-방법)
    - [7.1.2 내부에서 접속 방법](#712-내부에서-접속-방법)
  - [7.2. 데이터 확인](#72-데이터-확인)
- [ 8. cronjob 생성](#-8-cronjob-생성)
  - [8.1. cronjob 생성 파일 작성](#81-cronjob-생성-파일-작성)
  - [8.2. cronjob 실행 테스트](#82-cronjob-실행-테스트)
